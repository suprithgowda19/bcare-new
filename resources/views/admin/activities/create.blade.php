...
@section('page_title', 'Create New Activity')
            ...
            <div class="card-body">
                <form action="{{ route('admin.activities.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="content" class="form-control @error('content') is-invalid @enderror" rows="5" placeholder="Detailed description...">{{ old('content') }}</textarea>
