            ...
            <div class="card-body">
                <form action="{{ route('admin.news.update', $news->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="about" class="form-control @error('about') is-invalid @enderror" value="{{ old('about', $news->about) }}">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <div class="mt-2">
                                <img src="{{ asset('storage/' . $news->image) }}" class="img-thumbnail" width="120">
                            </div>
                    ...
                    <div class="mt-4 border-top pt-3">
                        ...
                        <a href="{{ route('admin.news.index') }}" class="btn btn-light">Back</a>
                    </div>
                </form>
            </div>
        </div>
