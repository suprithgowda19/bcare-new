...
<script>
/**
 * Re-initialize theme UI after every navigation
 * This is REQUIRED for PWA / AJAX navigation themes
 */
function reInitThemeUI() {
    ...
    // 2. Image lazy loader (preload-img)
...
// Normal page load
document.addEventListener('DOMContentLoaded', reInitThemeUI);

// PWA / cached navigation
window.addEventListener('pageshow', reInitThemeUI);

// Fallback for AJAX menu navigation
setTimeout(reInitThemeUI, 500);
</script>
