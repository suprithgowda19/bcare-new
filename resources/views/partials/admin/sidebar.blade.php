<div class="sidebar-wrapper">
    <div>
        ...
        <div class="logo-icon-wrapper"><a href="index.html"><img class="img-fluid" src="../assets/images/logo-icon.png"
                    alt=""></a></div>
                ...
                <ul class="sidebar-links" id="simple-bar">
                    ...
                    <li class="sidebar-list"><a class="sidebar-link sidebar-title" href="#">
                        ...
                        <ul class="sidebar-submenu">
                            ...
                            <li><a href="{{ route('admin.news.index') }}">News</a></li>
                                <li><a href="{{ route('admin.activities.index') }}">Activities/Services</a></li>
                                 <li><a href="{{ route('admin.updates.index') }}">Basavangudi updates</a></li>
                                  <li><a href="">Basavangudi Events</a></li>
                                  <li><a href="{{ route('admin.services.index') }}">Dashboard Services</a></li>
                                  <li><a href="{{ route('admin.about.index') }}">About</a></li>
                                  <li><a href="{{ route('admin.content.index') }}">Content</a></li>
                                  <li><a href="{{ route('admin.services.index') }}">Available Services</a></li>
                    ...
                    <li class="sidebar-list"><a class="sidebar-link sidebar-title" href="#">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                ...
                                <g>
                                    <g>
                                        <path d="M6.91699 14.854L9.90999 10.965L13.324 13.645L16.253 9.86499"
                                            stroke="#130F26" stroke-width="1.5" stroke-linecap="round"
                                            stroke-linejoin="round"></path>
                                        <path fill-rule="evenodd" clip-rule="evenodd"
